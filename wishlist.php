<?php
      ...
      if (isset($_POST['delete_item'])) {
            ...
            if ($varify_delete_items->rowCount()>0) {
                  $delete_wishlist_id = $conn->prepare("DELETE FROM `WHERE` id = ?");
...
<head>
      ...
      <title>Medicinal Plants - wishlist page</title>
</head>
<body> 
            ...
            <section class="products">    
                  ...
                  <div class="box-container">
                        ...
                        <form method="post" action="" class="box">
                              <input type="hidden" name="whislist_id" value="<?=$fetch_wishlist['id']; ?>">
