<?php
      ...
      if (isset($_POST['update_cart'])) {
            ...
            $update_qty = $conn->prepare("UPDATE `cart` SET qty = ? WHERE user_id = ?");
            $update_qty->execute([$qty, $user_id]);
...
<head>
      ...
      <title>Medicinal Plants - cart page</title>
</head>
<body> 
      ...
      <div class="banner">
            ...
            <section class="products">    
                  ...
                  <div class="cart-total">
                        ...
                        <div class="button">
                              <form method="post">
                                    <button type="submit" name="empty-cart" class="btn" 
