...
<head>
      ...
      <title>Medicinal Plants - order page</title>
</head>
<body> 
            ...
            <section class="products">
                  <div class="box-container">
                        ...
                        <div class="box-container">
                              ...
                              ?>
                              <div class="box" <?php if($fetch_order['status']=='cancle'){echo 'style="border:2px solid 
                                    red";';} ?>>
                                    <a href="view_order.php?get_id=<?=$fetch_order['id']; ?>">
                                          ...
                                          <div class="row">
                                                ...
                                                <p class="price">Price : $<?=$fetch_order['price']; ?> 
                                                      x <?=$fetch_order['qty']; ?></p>
