...
<head>
      ...
      <title>Medicinal Plants - order detail page</title>
</head>
<body> 
            ...
            <div class="main"> 
                  ...
                  <section class="order-detail">                  
                        <div class="title">
                              ...
                              Quisquam veritatis earum, dolorem laboriosam repudiandae commodi vero blanditiis harum 
                              voluptatum minus quos et esse fuga accusantium soluta eligendi.
                              Maiores, aut voluptatem!</p>
                        </div>                 
                        <div class="box-container">
                              ...
                              <div class="box">
                                    ...
                                    <div class="col">
                                          ...
                                          <p class="status" style="color:<?php if ($fetch_order['status']=='delevered'){echo
                                                'green';}elseif($fetch_order['status']=='canceled') {echo 'red';}else{echo
                                                'orange';}?>"><?=$fetch_order['status'] ?></p>
                                          <?php if ($fetch_order['status']=='canceled') { ?>
                                                <a href="checkout.php?get_id=<?=$fetch_product['id']; ?>" class="btn">order again</a>
                                          <?php }else{ ?>
                                                <form method="post">
                                                      <button type="submit" name="cancle" class="btn" onclick="return confirm
                                                            ('do you want to cancel this order')">cancle order</button>
                                                </form>
                                          <?php } ?>
                                    </div>
                              </div>
